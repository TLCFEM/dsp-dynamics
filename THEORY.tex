...
We present one more example of a cantilever wall under seismic load. The model and the corresponding configurations are depicted in \figref{fig:cantilever_model}.
\begin{figure}[htb!]
\centering\footnotesize
\begin{tikzpicture}
\begin{axis}[
